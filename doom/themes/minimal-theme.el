...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-keyword-face ((,class (:foreground ,"#8cd0d3" :weight bold))))
   ...
   `(font-lock-comment-face ((,class (:foreground ,"#87c0b9"))))
   ...
   `(mode-line
     ...
     `(org-todo ((,class (:background ,region :foreground ,"#aa4742" :weight bold))))
     `(org-done ((,class (:background ,region :foreground ,foreground :weight bold))))
     `(org-headline-done ((t (:foreground "#8cd0d3" :strike-through t))))
